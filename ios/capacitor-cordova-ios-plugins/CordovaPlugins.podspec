  ...
  Pod::Spec.new do |s|
    ...
    s.source = { :git => 'https://github.com/ionic-team/does-not-exist.git', :tag => '3.2.2' }
    ...
    s.frameworks = 'CoreTelephony', 'CoreLocation'
    s.vendored_frameworks = 'sources\SentryCordova\src\ios\Carthage\Build\iOS\Sentry.framework'
